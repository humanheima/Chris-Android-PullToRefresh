...
public class PullToRefreshListInViewPagerActivity extends AppCompatActivity implements OnRefreshListener<ListView> {
    ...
    private class ListViewPagerAdapter extends PagerAdapter {
        ...
        public View instantiateItem(ViewGroup container, int position) {
            ...
            ListAdapter adapter = new ArrayAdapter<>(context, android.R.layout.simple_list_item_1,
