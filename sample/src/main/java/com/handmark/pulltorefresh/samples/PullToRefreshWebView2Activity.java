...
public final class PullToRefreshWebView2Activity extends AppCompatActivity implements OnRefreshListener<WebView> {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        PullToRefreshWebView2 pullRefreshWebView = findViewById(R.id.pull_refresh_webview2);
